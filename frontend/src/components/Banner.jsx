...
function Banner() {
  return (
    <div className="my-16">
      <div className="text-center mb-8">
        ...
        className="flex flex-wrap items-center justify-center gap-4">
          <li>
            <Link
              to="/"
              className="bg-secondary/10 px-3 py-1 rounded-full hover:text-secondary hover:underline underline-offset-4"
            >
              Home
            </Link>
          </li>
      ...
      >
        <div
          className="md:min-h-112.5 h-80 w-full bg-center bg-cover bg-no-repeat"
